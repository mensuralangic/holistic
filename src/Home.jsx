const Home = () => {
    ...
    let image = ['https://img.freepik.com/premium-photo/female-doctor-with-glasses-stethoscope-her-neck_662214-709584.jpg?w=360'];
    return (
        <div  className=' flex gap-20 px-40 pt-14 pb-16 leading-loose text-slate-600'>
            <img className=' size-3/12'  src={image[0]} />
            <div>
